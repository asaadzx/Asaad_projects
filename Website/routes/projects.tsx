...
export default function Projects() {
  ...
  return (
    <>
      ...
      <div className="page-container min-h-screen bg-gradient-to-b from-blue-900 via-purple-900 to-indigo-900 text-white">
        ...
        <main className="projects-main container mx-auto px-4 py-8">
          ...
          <div className="project-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {projects.map((project, index) => (
              <div key={project.title} className={`project-card bg-white/10 backdrop-blur-md rounded-xl overflow-hidden shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300 hover:shadow-2xl animate__animated animate__fadeInUp animate__delay-${index % 3}s`}>
          ...
          <div className="call-to-action bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20 mb-12 animate__animated animate__fadeInUp animate__delay-1s">
            ...
            <a href="mailto:asaadzx@example.com" className="cta-button inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl transition-colors">
              Get in touch
            </a>
          </div>
        </main>

        <footer className="site-footer container mx-auto px-4 py-8 text-center text-white/60">
